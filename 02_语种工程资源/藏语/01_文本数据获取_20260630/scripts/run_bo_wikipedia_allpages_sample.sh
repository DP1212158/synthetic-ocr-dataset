...
CFG="$ROOT/configs/bo_wikipedia_allpages_sample.json"
OUT="$ROOT/data/bo_wikipedia_allpages_sample_20260630"
LOG="$ROOT/logs/bo_wikipedia_allpages_sample_20260630.log"
