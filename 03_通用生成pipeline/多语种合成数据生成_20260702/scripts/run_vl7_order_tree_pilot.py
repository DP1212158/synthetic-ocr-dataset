...
def default_zhuang_paths() -> dict[str, Path]:
    lang_gen = PROJECT_ROOT / "02_语种工程资源" / "壮语" / "03_合成数据生成_20260702"
    return {
        "output_dir": lang_gen / "VL7_order_tree_pilot",
        "text_jsonl": PROJECT_ROOT / "02_语种工程资源" / "壮语" / "01_文本数据获取_20260703" / "data" / "zhuang_expanded_text_pool_20260703" / "records.jsonl",
