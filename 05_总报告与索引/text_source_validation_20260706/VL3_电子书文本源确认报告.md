...
|---|---|---|---:|---:|---|
| 壮语 | pass_small_source_needs_longer_backup | zawiki-Vahcuengh-20200727.pdf / DjVuTXT | 9 | 0.948 | `05_总报告与索引/text_source_validation_20260706/cache/zhuang_archive_djvu_txt.txt` |
...
| 蒙古语 | needs_ebook_source | existing verified traditional Mongolian text pool; ebook source not yet verified | 384 | 1.0 | `02_语种工程资源/蒙古语/01_文本数据获取_20260702/data/local_verified_label_text_pool_cleaned_20260702/records.jsonl` |
...
| 白语 | needs_downloadable_ebook_source | 白语大理方言基础教程 / existing verified Bai text pool | 619 | 1.0 | `02_语种工程资源/白语/01_文本数据获取_20260702/data/local_verified_label_text_pool_20260702/records.jsonl` |
